...
import com.aloe_droid.presentation.store.component.WcSeparated
...
data class StoreDetailData(
    ...
    companion object {
        ...
        fun StoreDetailData.toDetailMap() = mapOf<Int, Pair<Boolean, ImageVector>>(
            ...
            R.string.dividedRestroom to (hasDividedRestroom to Icons.Outlined.WcSeparated),
            R.string.allows_group to (allowsGroup to Icons.Outlined.ChildCare),
            R.string.has_wifi to (hasWifi to Icons.Outlined.Wifi),
            R.string.allows_pets to (allowsPets to Icons.Outlined.Groups2),
            R.string.has_kids_facility to (hasKidsFacility to Icons.Outlined.Pets)
        )
    }
}
